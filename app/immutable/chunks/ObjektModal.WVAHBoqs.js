...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function mo(){return new ii({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Hs(),fragmentShader:`
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function _o(){return new ii({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Hs(),fragmentShader:`
		...
		`,blending:Bn,depthTest:!1,depthWrite:!1})}function Hs(){return`
...
`)}
                    ...
                    `})}).then(async J=>{const Ae=await J.json();if(!Ae.data.objektsConnection.edges.length&&l)t(1,l.minted=-1,l);else{t(2,f=Ae.data.transfersConnection.edges.map(Te=>Te.node));const Ne=await fetch(`${Yr.URL}/user/v1/by-address/${f.map(Te=>Te.to).join(",")}`);t(6,p=await Ne.json()),t(1,l=Ae.data.objektsConnection.edges[0].node)}}))},[a,l,f,n,c,u,p,v,d,h,b,x,y,L,A,w,r,s,o,m,_,Y,E,T,P,K,ae,R,D,N,O,z,X,j,$,le,H,Z,oe,Me]}class Om extends Wo{constructor(e){super(),Xo(this,e,wm,Am,Fs,{collection:0,objekt:1},null,[-1,-1])}}export{Om as O};
