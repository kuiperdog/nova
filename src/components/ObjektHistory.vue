...
<template>
    <table class="history">
        ...
        <tr v-for="transfer in transfers">
            ...
            <td>
                <RouterLink v-if="transfer.from.address !== nullAddress" :to="{ name: 'profile', params: { user: transfer.from.address } }">
            ...
            <td>
                <RouterLink v-if="transfer.to.address !== nullAddress" :to="{ name: 'profile', params: { user: transfer.to.address } }">
